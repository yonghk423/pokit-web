...
const HOME_PAGE_BY_SLUG = {
  ...
  spotlightRow: [
    ...
    { slug: "kitchen-prep-night-before", category: "Routine" },
  ],
  radioArticles: [
    ...
    { slug: "elevator-no-phone", category: "Commute" },
  ],
  designAwards: [
  ...
  sleepStories: [
    { slug: "phone-outside-bedroom", category: "Sleep" },
    { slug: "digital-sunset-nine-pm", category: "Sleep" },
    { slug: "evening-phone-basket", category: "Sleep" },
    { slug: "bedroom-lamp-warm-only", category: "Sleep" },
    { slug: "evening-wind-down", category: "Sleep" },
    { slug: "ten-minute-silence-before-bed", category: "Sleep" },
    { slug: "tomorrow-outfit-on-chair", category: "Sleep" },
    { slug: "gratitude-line-before-sleep", category: "Sleep" },
    { slug: "chamomile-bedtime-cup", category: "Sleep" },
    { slug: "bedtime-stretch-five", category: "Sleep" },
    { slug: "warm-shower-wind-down", category: "Sleep" },
    { slug: "audiobook-bedtime-ten", category: "Sleep" },
  ],
  cityGuides: [
