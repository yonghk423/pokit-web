  ...
  return (
    <a
      ...
      className={cn(
        ...
        variant === "button" &&
          "inline-flex min-h-12 items-center justify-center bg-indigo px-6 font-sans text-[0.82rem] font-extrabold tracking-[0.06em] text-white no-underline hover:bg-ink",
        className,
      )}
      onClick={handleClick}
    >
